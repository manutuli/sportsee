...
function Monitoring(props){
    ...
    <div id="monitoring" className="monitoring">
        <article className="monitoring-article" id="calories">
            <div className="icon-monitoring icon-calories">
            ...
            <div className="monitoring-info info--calories">
                <span className="monitoring-title">
                    <p>{data?.calorieCount}kCal</p>
                    <p className="title--calories">Calories</p>
                </span>
            </div>
        </article>
        <article className="monitoring-article" id="proteines">
            <div className="icon-monitoring icon-proteines">
            ...
            <div className="monitoring-info info--proteines">
                <span className="monitoring-title">
                    <p>{data?.proteinCount}g</p>
                    <p className="title--proteines">Protéines</p>
                </span>
            </div>
        </article>
        <article className="monitoring-article" id="glucides">
            <div className="icon-monitoring icon-glucides">
            ...
            <div className="monitoring-info info--glucides">
                <span 
                    className="monitoring-title">
                    <p>{data?.carbohydrateCount}g</p>
                    <p className="title--glucides">Glucides</p>
                </span>
            </div>
        </article>
        <article className="monitoring-article" id="lipides">
            <div className="icon-monitoring icon-lipides">
            ...
            <div className="monitoring-info info--lipides">
                <span className="monitoring-title">
                    <p>{data?.lipidCount}g</p>
                    <p className="title--lipides">Lipides</p>
                </span>
            </div>
        </article>
    </div>)
